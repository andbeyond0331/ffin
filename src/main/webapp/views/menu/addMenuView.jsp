...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            //alert(modalOp.find('button.btn.btn-primary').html());
                ...
                modalOp.find('button.btn.btn-primary').on("click", function(){
                    ...
                    divElemOp = "<div class=\"form-group\" id=\"optionName"+countOp+"\" name=\"optionName\">"+
                    ...
                    "<input type=\"button\" value=\"삭제\" onclick=\"javascript:removeELOption("+countOp+")\"/>" +
                    "</div>";
        ...
        function removeEL(idIndex){
            $("#optionGroupName"+idIndex).remove();
            confirm("삭제하시겠습니까?");
            count--;
        }

        function removeELOption(idIndex){
            $("#optionName"+idIndex).remove();
            confirm("삭제하시겠습니까?");
            countOp--;
        }
