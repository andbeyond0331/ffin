    ...
    <form class="form-horizontal">
        ...
        <div class="form-group">
                    <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
                        <tbody>
                        <tr>
                            <td><input id="postTitle" type="text" class="form-control" placeholder="게시글 제목" name="postTitle" maxlength="50"></td>
                        </tr>
                        <tr>
                            <td><textarea id="postContent" class="form-control" placeholder="게시글 내용" name="postContent" maxlength="3000" style="height: 350px;"></textarea></td>
                        </tr>
                            <!-- 푸드트럭 사업자등록증 파일업로드란 -->
                                <td>
