...
<div class="container" align="center">
    ...
    <div class="col-md-10" style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
        <c:if test="${sessionScope.role eq 'admin'}">
            <c:if test="${post.secretKey == 0}">
                <button type="button" id="goBlindPost" class="btn btn-default" style="padding: 5px; height: fit-content;">비공개처리</button>
            </c:if>
            <c:if test="${post.secretKey == 1}">
                <button type="button" id="goSeePost" class="btn btn-default" style="padding: 5px; height: fit-content;">공개처리</button>
            </c:if>
        </c:if>
        <button type="button" id="goPostList" class="btn btn-cancle" style="display: flex; align-items: center; padding: 5px; height: fit-content;"><ion-icon name="reorder-three-outline"></ion-icon>&nbsp;목록</button>
    ...
    <div class="panel panel-default">
        <div class="col-md-10 panel-heading" style="border-radius:10px ; border: 0; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.2); transition: 0.3s;">
            ...
            <div class="panel-body">
                ...
                <ul class="col-11" style="display: flex;">
                        ...
                        <midium class="col-8" colspan="2" style="font-size: 14px; display: flex;">${post.postContent}</midium>
                </ul>
    ...
    <%-- 댓글 쓰기 --%>
    <div class="col-12 row reply_write" style="display: flex; align-items: center; margin-top: 25px; justify-content: center;">
    <div style="padding: 0; display: flex; justify-content: center;">
        <a href="other_profile.do?other_nick=">
            <img id="write_reply_profileImage" style="margin: 0; box-shadow: 0 2px 4px 2px rgb(0 0 0 / 15%); border-radius: 2rem" src="../../../resources/image/${sessionScope.user.userProImg}${sessionScope.truck.truckProImg}" />
             </a>
       </div>
    <div class="col-sm-6" class="input_reply_div">
        <input class="w-100 form-control" style="height: 35px; border-radius: 50px; padding-left: 10px;" id="input_reply${post.postNo }"  type="text" placeholder="댓글입력...">
        </div>
    <div class="col-1" style="padding: 0; text-align: end;">
        <button type="button" idx="${post.postNo }" class="btn btn-default mb-1 write_reply" style="height: 35px; font-size: 12px; padding: 4px 8px 4px 8px; margin: 0; text-align: center; width: 75px;">댓글달기</button>
        </div>
