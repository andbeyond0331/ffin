            ...
            $.ajax({
                ...
                success : function(data) {
                    ...
                    for(const i in data.replyList){
                        ...
                        listHtml += "<div style='display: -webkit-box; align-items: center; justify-content: space-between; margin-top: 10px; padding: 5px;' class='row replyrow reply" + commentNo + "'>";
...
<div class="container" align="center">
    ...
    <br/>
    <%-- 댓글 리스트 --%>
    <div class="reply-list col-12 reply-list${post.postNo }"></div>
    ...
    <div class="col-1" style="padding-left: 0;">
        <a href="other_profile.do?other_nick=">
            <img id="write_reply_profileImage" style="margin: 0;" src="../../../resources/image/${sessionScope.user.userProImg}${sessionScope.truck.truckProImg}" />
             </a>
       </div>
    <div class="col-sm-9" class="input_reply_div">
        <input class="w-100 form-control" style="height: 35; border-radius: 50px;" id="input_reply${post.postNo }"  type="text" placeholder="댓글입력...">
        </div>
    <div class="col-2" style="padding: 0; text-align: end;">
        <button type="button" idx="${post.postNo }" class="btn btn-default mb-1 write_reply" style="height: 35; font-size: 12px; padding: 4px 8px 4px 8px; margin: 0; text-align: center; width: 75px;">댓글달기</button>
        </div>
