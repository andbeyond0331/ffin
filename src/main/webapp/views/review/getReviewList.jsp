    ...
    <form name="detailForm">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
            ...
            <tr>
                ...
                <td class="ct_list_b" width="150">리뷰 작성자</td>
                <td class="ct_line02"></td>
                <td class="ct_list_b" width="150">리뷰 별점</td>
                <td class="ct_line02"></td>
                <td class="ct_list_b" width="150">메뉴 내용</td>
                <td class="ct_line02"></td>
                <td class="ct_list_b">사장님 댓글</td>
                <td class="ct_line02"></td>
                <td class="ct_list_b">리뷰 이미지</td>
            </tr>
            <tr>
...
<%--                        <span class="review" hidden="">${review.menuNo}</span>--%>
<%--                        <span class="review" hidden="">${review.menuTruckId}</span>--%>
