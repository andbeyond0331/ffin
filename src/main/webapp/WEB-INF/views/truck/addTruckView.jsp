...
<div class="container">
    ...
    <form method="form-horizontal">
        ...
        <div class="form-group">
            <label for="truckId" class="col-sm-offset-1 col-sm-3 control-label">아이디</label>
            <input type="text" class="form-control" id="truckId" name="truckId" placeholder="아이디를 입력하세요." required
                   maxlength="10"/>
        ...
        <tr>
            <th>
                <label for="truckPassword" class="col-sm-offset-1 col-sm-3 control-label">비밀번호</label>
            </th>
            <td>
